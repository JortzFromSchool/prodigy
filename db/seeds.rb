...
track1 = Track.create({title: "Daftendirekt", artist_id: artist1.id, lyrics: lyrics1, description: description1, album_id: 1, track_number: 1, views: 10800, genre: "Dance", producer_id: artist1.id})
...
track2 = Track.create({title: "WDPK 83.7 FM", artist_id: artist1.id, lyrics: lyrics2, description: description2, album_id: 1, track_number: 2, views: 100, genre: "Dance", producer_id: artist1.id})
...
track3 = Track.create({title: "Revolution 909", artist_id: artist1.id, lyrics: lyrics3, description: description3, album_id: 1, track_number: 3, views: 6900, genre: "Dance", producer_id: artist1.id})
...
track4 = Track.create({title: "Da Funk", artist_id: artist1.id, lyrics: lyrics4, description: description4, album_id: 1, track_number: 4, views: 100, genre: "Dance", producer_id: artist1.id})
...
track5 = Track.create({title: "Pheonix", artist_id: artist1.id, lyrics: lyrics5, description: description5, album_id: 1, track_number: 5, views: 100, genre: "Dance", producer_id: artist1.id})
...
track6 = Track.create({title: "Fresh", artist_id: artist1.id, lyrics: lyrics6, description: description6, album_id: 1, track_number: 6, views: 100, genre: "Dance", producer_id: artist1.id})
...
track7 = Track.create({title: "Around the World", artist_id: artist1.id, lyrics: lyrics7, description: description7, album_id: 1, track_number: 7, views: 119200, genre: "Dance", producer_id: artist1.id})
