...
import { createUpvote, deleteUpvote, updateUpvote, fetchTrack, deleteAnnotation} from "../../actions/track_actions";
...
const mapDispatchToProps = dispatch => ({
    ...
    updateUpvote: (upvote, upvoteId) => dispatch(updateUpvote(upvote, upvoteId)),
